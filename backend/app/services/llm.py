...
def _build_llm_prompt(
    ...
    prompt_parts.extend([
        ...
        "",
        "1. **Key Mistakes Summary**: Briefly summarize the most critical errors (2-3 sentences)",
        ...
        "3. **Specific Lessons**: List 3-5 specific lessons the player should learn from this game",
        "4. **Practical Improvement Tips**: Provide 3-4 actionable tips for improvement",
